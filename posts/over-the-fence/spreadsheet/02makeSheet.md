...
## 開き方
google spreadsheetは開き方を2つ紹介します。

google spreadsheetはgoogleのアカウントでログインしたchromeなら簡単に開くことができます。
...
終わり方は、簡単です。
Google spreadsheetは自動保存になっているので、そのままタブを閉じるだけで、終了できます。

# 表を作るための基本的な機能

次に、表を作るための基本的は機能を説明します。
...
円マークをつけることもできます。お金を扱う資料を作る際には便利ですね。
...
行方向の数値や列方向のアルファベットが書いてあるセルの、セルとセルの間にカーソルを合わせてドラッグすることで、セルの任意のサイズに変更できます。
